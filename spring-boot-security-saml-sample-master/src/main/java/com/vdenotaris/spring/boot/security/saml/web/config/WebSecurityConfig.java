...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public WebSSOProfileConsumer webSSOprofileConsumer() {
		WebSSOProfileConsumerImpl obj = new WebSSOProfileConsumerImpl();
		obj.setMaxAuthenticationAge(604800);
		return obj;
	}
	...
	public TLSProtocolConfigurer tlsProtocolConfigurer() {
		TLSProtocolConfigurer tlsc = new TLSProtocolConfigurer();
		tlsc.setSslHostnameVerification("allowAll"); 
		return tlsc;
	}
	...
	public ExtendedMetadataDelegate ssoCircleExtendedMetadataProvider() throws MetadataProviderException {
		String idpSSOCircleMetadataURL = "https://finaxis.samlidp.io/saml2/idp/metadata.php";
	...
	public MetadataGenerator metadataGenerator() {
		...
		metadataGenerator.setEntityId("gateway.finaxis.com.br");
	...
	public SavedRequestAwareAuthenticationSuccessHandler successRedirectHandler() {
		...
		successRedirectHandler.setDefaultTargetUrl("/app/welcome/default/#/login");
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/").permitAll().antMatchers("/error").permitAll().antMatchers("/saml/**").permitAll().anyRequest().authenticated();
